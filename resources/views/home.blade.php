<html lang="en">
  ...
  <body class="dash">
    <aside class="side-nav" id="show-side-navigation1">
      ...
      <ul class="categories">
        <li><i class="fa fa-home fa-fw" aria-hidden="true"></i><a href="#"> Billing</a>
          <ul class="side-nav-dropdown">
            <li><a href="/invoice">Create a Invoice</a></li>
          </ul>
        </li>
        <li><i class="fa fa-support fa-fw"></i><a href="#"> Inventory Tools</a>
          <ul class="side-nav-dropdown">
            <li><a href="/additem">Add items</a></li>
            <li><a href="/entry">View Items</a></li>
          </ul>
        </li>
